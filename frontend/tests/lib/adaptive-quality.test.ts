...
import { AdaptiveQualityController, DEFAULT_POLL_INTERVAL_MS } from '@/lib/adaptive-quality';
import { VIDEO_QUALITY_LADDER, MIN_CHANGE_INTERVAL_MS, type QualityLevel } from '@/lib/bandwidth';
