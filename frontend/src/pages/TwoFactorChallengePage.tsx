  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-4 py-8 sm:px-6">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-lg items-center">
        <Card className="card-glow w-full rounded-3xl border-[var(--meet-border)] bg-[var(--meet-surface)]">
          <CardHeader className="space-y-2 text-center">
            <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-[var(--meet-accent-soft)]">
              <ShieldCheck className="h-5 w-5 text-[var(--meet-accent)]" />
            </div>
          ...
          <CardContent className="space-y-4">
            {!useBackupCode ? (
              <>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-center text-xs text-[var(--meet-text-muted)]">
            ...
            <div className="text-center text-sm">
              <Link
                ...
                className="font-medium text-[var(--meet-accent)] hover:underline"
              >
                Back to login
              </Link>
            </div>
